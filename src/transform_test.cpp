...
int main(int argc, char** argv)
{
    ...
    // };
    // // GraspNet output (Glue Stick (tapi graspnya dari samping))
    double translation[3] = {0.04632061, -0.02004719,  0.283  };
    double rotation_matrix[3][3] = {
        { 0.9810783,   0.19336247, -0.00981127},
        {-0.1933528 ,  0.9811274 ,  0.00193362},
        { 0.01    ,    0.      ,    0.99995  }
    };
